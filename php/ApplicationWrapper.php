<?php namespace GlobalTechnology\MinistryViewReports {
	...
	class ApplicationWrapper {
		...
		public function getAPIServiceTicket( $service = false ) {
			return $this->casClient->retrievePT( $service ? $service : ( Config::get( 'ministry-view-api.endpoint' ) . '/token' ), $code, $msg );
		}
		...
		public function appConfig() {
			return json_encode( array(
				...
				'api'         => array(
					...
					'ministryView' => Config::get( 'ministry-view-api.endpoint' ),
